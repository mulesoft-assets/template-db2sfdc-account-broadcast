# Anypoint Template: DB to SFDC Account Broadcast
...
Simple steps to get DB to SFDC Accounts Broadcast running.

**Note:** This particular Anypoint Template illustrate the broadcast use case between SalesForce and a Database, thus it requires a DB instance to work.
...
Once your app is all set and started, supposing you choose as domain name `db2sfdcaccountbroadcast` to trigger the use case you just need to hit `http://db2sfdcaccountbroadcast.cloudhub.io/migrateaccounts`.
...
###  Inbound Flow
**HTTP Endpoint** - Start Report Generation
